...
export const EDUCATION_CATEGORIES = [
  {
    ...
    keys: ["school", "10th", "12th", "sslc", "hsc", "plus2", "puc", "cbse", "icse", "matric"],
    items: [
  ...
  },
  {
    ...
    keys: ["arts", "ba", "ma", "humanities", "bachelorofarts", "masterofarts", "msw", "bsw", "bfa", "mfa"],
    items: [
  ...
  },
  {
    ...
    keys: ["management", "bba", "bbm", "mba", "pgdm", "pgdba", "pgdhrm", "business"],
    items: [
  ...
  },
  {
    ...
    keys: ["bca", "mca", "computer", "dca", "pgdca", "computerapplications"],
    items: [
  ...
  },
  {
    ...
    keys: ["mbbs", "medical", "doctor", "bds", "bams", "bhms", "bsms", "bums", "bnys", "pharmacy", "pharm", "bpharm", "mpharm", "dpharm", "md", "ms", "dnb"],
    items: [
      "MBBS", "MD", "MS (Medicine)", "DNB", "Diploma in Industrial Health (AFIH)", "BDS", "MDS", "BAMS (Ayurveda)", "BHMS (Homoeopathy)",
      "BSMS (Siddha)", "BUMS (Unani)", "BNYS (Naturopathy & Yoga)", "B.Pharm", "M.Pharm", "Pharm.D", "D.Pharm",
    ],
  },
  {
    id: "design", label: "Architecture & Design",
    keys: ["architecture", "barch", "march", "design", "bdes", "mdes", "nift"],
    items: [
  ...
  },
  {
    ...
    keys: ["bed", "med", "teaching", "teacher", "deled", "dted", "bped", "mped"],
    items: [
  ...
  },
  {
    ...
    keys: ["hotel", "hotelmanagement", "bhm", "catering", "hospitality", "aviation", "airline", "travel"],
    items: [
...
const POPULAR = [
  ...
  "B.E. Mechanical Engineering", "B.Tech Information Technology (IT)", "B.Sc Computer Science", "B.Com (General)",
  "B.A. English", "MBA Human Resource Management", "M.E. Manufacturing Engineering", "B.Sc Nursing", "Ph.D in Mechanical Engineering",
];
